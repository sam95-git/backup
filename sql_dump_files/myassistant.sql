...
--
-- AUTO_INCREMENT for table `ma_config`
--
ALTER TABLE `ma_config`
  MODIFY `application_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60000;
